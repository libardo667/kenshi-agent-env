...
AFFORDANCES: tuple[Affordance, ...] = (
    ...
    Affordance(
        ...
        gap="Only cells the export happens to include are addressable; there is no scroll.",
    ),
    Affordance(
        Interface.INVENTORY,
        Operation.INTERACT,
    ...
    Affordance(
        ...
        Mechanism.NONE,
        "",
        native_entry_point="InventoryGUI::tryToEquip @ 0x70D830",
        gap="The agent can see its gear but cannot change it.",
    ),
    Affordance(
        Interface.INVENTORY,
        Operation.EXIT,
    ...
    Affordance(
        ...
        Mechanism.NONE,
        "",
        gap="Same missing scroll as inventory; a large shop is only partly addressable.",
    ),
    Affordance(
        Interface.TRADE,
        Operation.INTERACT,
    ...
    Affordance(
        ...
        "",
        gap=(
            "Movement is only ever toward a nearby dialogue target, so the "
            "agent cannot leave the building it starts in."
        ),
    ),
    Affordance(
        Interface.MAP,
