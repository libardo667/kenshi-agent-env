...
| `regroup_with_squad_member` | 1.0 | yes | monitored_option | controller terminal | yes | 5 | `control.regroup_with_squad_member`, `game.pause`, `game.speed`, `identity.stable_handles`, `squad.basic`, `squad.health` |
