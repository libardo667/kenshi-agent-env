...
from kenshi_agent.native_commands import (
    ...
    NATIVE_CONFIRM_CHARACTER_EDITOR_WIRE_COMMAND,
    NATIVE_CONTEXT_ACTION_WIRE_COMMAND,
    NATIVE_DIALOGUE_OPTION_WIRE_COMMAND,
...
NATIVE_WIRE_COMMANDS: dict[str, str] = {
    ...
    NATIVE_DIALOGUE_OPTION_CAPABILITY: NATIVE_DIALOGUE_OPTION_WIRE_COMMAND,
    ...
    NATIVE_CONFIRM_CHARACTER_EDITOR_CAPABILITY: NATIVE_CONFIRM_CHARACTER_EDITOR_WIRE_COMMAND,
}
